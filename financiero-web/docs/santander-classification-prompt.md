...
- `Futuro`: inversiones, ahorro, GBM, CETES, ETFs, acciones, crypto, fondos, aportaciones patrimoniales, herramientas de software, IA y cloud productivas.
- `Vida`: costo de vida necesario y estricto: súper/despensa, farmacia/salud, gasolina, telefonía, servicios, renta/deuda.
...
3. Si menciona OpenAI, ChatGPT, Codex, Fiverr, Opus, Google Cloud, AWS, Vercel, GitHub, Supabase, Cloudflare, Notion, Zoom, Figma, Canva, Slack, Discord, Claude, Cursor, Windsurf, Replit, Midjourney, Runway, ElevenLabs o software usado para trabajar: `Futuro / Inversion`.
...
- `OPENAI *CHATGPT SUBSCR`, `$399.00` -> `gasto`, `Futuro`, `Inversion`.
- `CODEX`, `FIVERR`, `OPUS`, `TELCEL` -> `gasto`; Codex/Fiverr/Opus van a `Futuro / Inversion`, Telcel va a `Vida / Costo de Vida`.
