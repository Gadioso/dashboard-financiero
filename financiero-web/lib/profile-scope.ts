...
export function normalizeProfileId(value?: string | null) {
  // Some environment dashboards preserve surrounding quotes. A quoted UUID
  // should retain the same strict validation instead of making the dashboard
  // silently fall back to an empty tenant.
